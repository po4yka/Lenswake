...
object KnownPixelCameraProfileCatalog {
    ...
    val pixel8ProAndroid17Camera69481630: PixelCameraProfile =
        PixelCameraProfile(
            id =
                ProfileId(
            ...
            targets =
                mapOf(
                    ...
                    AutomationAction.OPEN_TIME_LAPSE_SPEED_CONTROL to
                        actionSelector(
                    ...
                    AutomationAction.SELECT_NIGHT_SIGHT_TIME_LAPSE to
                        UiSelectorSet(
                            selectors =
                                listOf(
                                    cameraSelector(
                    ...
                    AutomationAction.STOP_RECORDING to
                        actionSelector(
                            resourceId = "ComposeShutter",
            ...
            dialogProfiles =
                mapOf(
                    ...
                    PixelCameraDialogKind.CAMERA_DISABLED to
                        PixelCameraDialogProfile(
                            presence =
                                dialogPresence(
            ...
            stateSignals =
                mapOf(
                    ...
                    PixelCameraStateSignal.VIDEO_MODE_ACTIVE to
                        stateSelector(
                            resourceId = "$PIXEL_CAMERA_PACKAGE:id/mode_chip_text",
                            text = "Video",
                            expectedSelected = true,
                    ...
                    PixelCameraStateSignal.TIME_LAPSE_SPEED_X5_ACTIVE to
                        speedStateSelector(
                            "Time Lapse 5 times speed",
                            "5×",
                        ),
                    PixelCameraStateSignal.TIME_LAPSE_SPEED_X10_ACTIVE to
                        speedStateSelector(
                            "Time Lapse 10 times speed",
                            "10×",
                        ),
                    PixelCameraStateSignal.TIME_LAPSE_SPEED_X30_ACTIVE to
                        speedStateSelector(
                    ...
                    PixelCameraStateSignal.NIGHT_SIGHT_TIME_LAPSE_MODE_ACTIVE to
                        UiSelectorSet(
                            selectors =
                                listOf(
                                    cameraSelector(
                    ...
                    PixelCameraStateSignal.RECORDING_ACTIVE to
                        UiSelectorSet(
                            selectors =
                                listOf("Stop video", "Stop time lapse").map { description ->
                                    cameraSelector(
                                        resourceId = "ComposeShutter",
                    ...
                    PixelCameraStateSignal.NOT_RECORDING to
                        UiSelectorSet(
                            selectors =
                                listOf(
                                    cameraSelector(
    ...
    private fun timeLapseSpeedSelector(speed: Int): UiSelectorSet =
        actionSelector(
     ...
     */
    private fun dialogPresence(text: String?): UiSelectorSet =
        UiSelectorSet(
            selectors =
                listOf(
                    cameraSelector(
    ...
    private fun dialogAction(text: String): UiSelectorSet =
        UiSelectorSet(
            selectors =
                listOf(
                    cameraSelector(
