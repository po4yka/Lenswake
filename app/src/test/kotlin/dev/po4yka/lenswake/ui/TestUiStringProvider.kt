...
internal object TestUiStringProvider : UiStringProvider {
    private val values = mapOf(
        ...
        R.string.diagnostics_sessions_section to "Sessions",
        R.string.diagnostics_timeline_section to "Timeline",
        R.string.diagnostics_session_duration to "Duration: %1\$s",
        R.string.diagnostics_retry_count to "Retries: %1\$d",
        R.string.diagnostics_fallback_count to "Gesture fallbacks: %1\$d",
        R.string.diagnostics_privileged_fallback_count to "Privileged: %1\$d",
        R.string.diagnostics_selector_confidence to "Selector: %1\$d / %2\$d",
        R.string.diagnostics_selector_confidence_unavailable to "Selector: no score",
        R.string.diagnostics_event_duration to "Duration: %1\$s",
        R.string.diagnostics_event_method to "Method: %1\$s",
        R.string.diagnostics_event_attempt to "Attempt: %1\$d",
        R.string.diagnostics_selector_match_index to "Selector match: #%1\$d",
        R.string.diagnostics_selector_match_signals to "Selector match: #%1\$d (%2\$s)",
        R.string.diagnostics_event_metrics_separator to " · ",
        ...
        R.string.diagnostics_scheduled_session_title to "Scheduled session",
        R.string.diagnostics_rehearsal_session_title to "Rehearsal",
        R.string.diagnostics_session_detail to "%1\$s · Session %2\$s",
        R.string.diagnostics_duration_milliseconds to "%1\$dms",
        R.string.diagnostics_duration_seconds to "%1\$ds",
        R.string.diagnostics_duration_minutes_seconds to "%1\$dm %2\$ds",
        R.string.diagnostics_duration_hours_minutes to "%1\$dh %2\$dm",
